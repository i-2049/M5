...
public class Main {
    ...
    // TO DONEModify this code to check if the given string is non-empty, contains at least
    ...
    public static boolean checkForPassword(String str, int minLength) {
        // must meet: Not empty!!
        // needs: one uppercase, lowercase, digit,
        // must meet: min length
    ...
    // TO DONE Modify this method to return a list of all email addresses contained in the
    ...
    // TO DONE Modify this method to check whether or not the string contains the same capital letter
